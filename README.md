...
### На данной странице продемонастрирована часть моих работ, выполненных в ходе академической и самообразовательной деятельностей
...
# Data Analysis
## [Анализ поведения клиентов на автозаправочных станциях](https://nbviewer.jupyter.org/github/EuMentality/ML-DA/blob/main/notebooks/toplivo.ipynb)
#### В этой работе проведен анализ транзакций на 6 автозаправочных станциях. Выявлены закономерности в поведении клиентов, собраны описательные статистики по группам клиентов, проанализирована динамика продаж.
